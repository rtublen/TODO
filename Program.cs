...
namespace TODO
{
    class Program
    {
        ...
        {
            string sql = "SELECT Id, Name, DueDate ,CompletedAt FROM MyTask WHERE CompletedAt IS NULL";
        ...
        private static void ListTasks()
        {
            ...
            {
                SetTaskToCompleted(myTaskList);
            }
            Console.Clear();
        }

        private static void SetTaskToCompleted(IList<MyTask> myTaskList)
        {
            Console.Clear();
            ...
            CompleteTask(idToUpdate);
        }

        private static void CompleteTask(int idToUpdate)
        {
            
            var sql = $@"
                SELECT Id, Name, DueDate, CompletedAt FROM MyTask
                WHERE Id=@Id
                UPDATE MyTask SET CompletedAt = @CompletedAt
                WHERE Id=@Id";
